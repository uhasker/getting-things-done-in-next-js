...
- [A Brief Introduction to JavaScript](chapter1/README.md)
  ...
  - [Classes](chapter1/06-classes.md)
  - [Error Handling](chapter1/07-error-handling.md)
  - [Basic Data Structures](chapter1/08-basic-datastructures.md)
  - [Functional Thinking](chapter1/09-functional-thinking.md)
  - [Asynchronous Programming](chapter1/10-asynchronous-programming.md)
...
- [Typesafe SQL with Drizzle](chapter5/README.md)
  ...
  - [Inserting, Updating and Deleting Data](chapter5/02-inserting-updating-and-deleting-data.md)
  - [Selecting Data](chapter5/03-selecting-data.md)
  - [Multiple Tables](chapter5/04-multiple-tables.md)
  - [Migrations](chapter5/05-migrations.md)

- [A Vanilla Client](chapter6/README.md)

  - [Hypertext Markup Language](chapter6/01-hypertext-markup-language.md)
  - [Marking Up Text](chapter6/02-marking-up-text.md)
  - [Hyperlinks and Images](chapter6/03-hyperlinks-and-images.md)
  - [The Document Object Model](chapter6/04-the-document-object-model.md)
  - [Events](chapter6/05-events.md)
  - [Web Forms](chapter6/06-web-forms.md)
  - [A Simple Client](chapter6/07-a-simple-client.md)

- [Adding Spice with React](chapter7/README.md)

  - [React Components](chapter7/01-react-components.md)
  - [React State](chapter7/02-react-state.md)
  - [React Effects](chapter7/03-react-effects.md)

- [Moving to the Server with Next.js](chapter8/README.md)

  - [Setup](chapter8/01-setup.md)
  - [Pages and Layouts](chapter8/02-pages-and-layouts.md)
  - [More on Routes](chapter8/03-more-on-routes.md)
  - [Server and Client Components](chapter8/04-server-and-client-components.md)

- [Becoming Pretty with Tailwind CSS](chapter9/README.md)

  - [Setup](chapter9/01-setup.md)
  - [Typography Utilities](chapter9/02-typography-utilities.md)
  - [Background Utilities](chapter9/03-background-utilities.md)
  - [Size Utilities](chapter9/04-size-utilities.md)
  - [Border Utilities](chapter9/05-border-utilities.md)
  - [Spacing Utilities](chapter9/06-spacing-utilities.md)
  - [Flexbox](chapter9/07-flexbox.md)
  - [Grid](chapter9/08-grid.md)
