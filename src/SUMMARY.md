...
- [A Brief Introduction to JavaScript](chapter1/README.md)
  ...
  - [Modules](chapter1/11-packages.md)
...
- [A Vanilla Client](chapter4/README.md)
  ...
  - [Hypertext Markup Language](chapter4/01-hypertext-markup-language.md)
...
- [Adding Spice with React](chapter5/README.md)
  ...
  - [React Components](chapter5/01-react-components.md)
  - [React State](chapter5/02-react-state.md)
  - [React Effects](chapter5/03-react-effects.md)

- [Moving to the Server with Next.js](chapter6/README.md)

  - [Setup](chapter6/01-setup.md)
